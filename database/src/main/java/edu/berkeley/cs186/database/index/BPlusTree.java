...
public class BPlusTree {
    ...
    private class BPlusTreeIterator implements Iterator<RecordId> {
        ...
        private Iterator<RecordId> leafIter;
        private LeafNode curLeaf;

        public BPlusTreeIterator(LeafNode curLeaf) {
            this.curLeaf = curLeaf;
            this.leafIter = curLeaf.scanAll();
        }

        public BPlusTreeIterator(LeafNode curLeaf, DataBox key) {
            this.curLeaf = curLeaf;
            this.leafIter = curLeaf.scanGreaterEqual(key);
        }

        @Override
        public boolean hasNext() {
            // TODO(proj2): implement
            if (leafIter.hasNext() || curLeaf.getRightSibling().isPresent()) {
                return true;
            }
            return false;
        }
        ...
        public RecordId next() {
            ...
            if (!leafIter.hasNext()) {
                ...
                leafIter = curLeaf.scanAll();
            }
            return leafIter.next();
        }
    }
}
